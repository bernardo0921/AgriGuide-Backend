...
class MicrosoftGraphEmailClient:
    ...
    def __init__(self):
        self.tenant_id = getattr(settings, 'MS_TENANT_ID', '')
        self.client_id = getattr(settings, 'MS_CLIENT_ID', '')
        self.client_secret = getattr(settings, 'MS_CLIENT_SECRET', '')
        self.default_sender = getattr(settings, 'MS_DEFAULT_SENDER', 'noreply@yourdomain.com')
